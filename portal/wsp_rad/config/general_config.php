...
if($staging == 1){
    $webapp_url = "https://wspclients.com/psn_jasvir/";
    $file_upload_directory = "uploads/";
}
...
//Permissions
$permissions = array();
$permissions["record_ownership"] = "shared"; // Single Record Ownership only to the author
...
//User Permissions
$permissions["staff_record_types"] = array("booking","desk"); //
$permissions["staff_disabled_rights"] = array(
    // "rec_type"=>array("delete")    
);
//Permissions
...
$mailer_sandbox = array("smtp.gmail.com","wspkkptesting@gmail.com","cctiivvnogesxpua","tls",587,"Paesano Test");

$mailer_live = array("smtp.gmail.com","wspkkptesting@gmail.com","cctiivvnogesxpua","tls",587,"Paesano Test");

$mailer_additional = array("smtp.gmail.com","wspkkptesting@gmail.com","cctiivvnogesxpua","tls",587,"Paesano Test");
