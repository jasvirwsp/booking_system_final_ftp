...
<!-- <div class="form-group ic_user_user col-md-5 d-inline-block">
        ...
        <input type="hidden" class="form-control user_user" placeholder="User"  name="user" value="<?php echo "user_".rand(); ?>" style="text-transform:lowercase;">
            <!-- </div>             -->
...
<!-- <div class="form-group ic_user_password col-md-5 d-inline-block">
        ...
        <input type="hidden" class="form-control user_password" placeholder="Password"  name="password" value="<?php echo "pass_".rand(); ?>">
            <!-- </div>             -->
        <!-- <div class="form-group ic_user_role col-md-5 d-inline-block">
             <label class="user_role" for="user_role">Role / Type</label> -->
             <input type="hidden" class="form-control user_role" placeholder="user role"  name="role" value="user">
            <!-- <select class="form-control user_role" name="role">
                    <option value="admin">Admin</option>
                                              <option value="user">User</option>        <option value="staff">Staff</option>                                     
                                                   </select>
                </div>             -->
        <!-- <div class="form-group ic_user_status col-md-5 d-inline-block">
             <label class="user_status" for="user_status">Status</label> -->
             <input type="hidden" class="form-control user_status" placeholder="user role"  name="user_status" value="active">   
