                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title"><?php echo beautify_meta_name(title_case("booking_desk")); ?> <!-- Button trigger modal -->
<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#add_booking_desk"><i class="fe-plus"></i> Add <?php echo beautify_meta_name(title_case("booking_desk"));?></button>
</h4>
                                </div>
                            </div>
                        </div>     
...
//Action Buttons
$edit_button_url = "edit_booking_desk.php?booking_desk_id=";
$view_button_url = "view_booking_desk.php?booking_desk_id=";
$delete_button_class = "delete_booking_desk";
//Records
$per_page = 20;
//Offset settings
...
<table class="table table-striped <?php if (safe_get('show_all_fields') == 'yes') {echo 'table-responsive';} ?>" id="list_table_booking_desk">
<?php
...
<!-- Col 1 -->
        ...
        <a href="javascript:void" class="btn btn-secondary btn-sm export_to_csv_booking_desk"><i class="fa fa-download" aria-hidden="true"></i> CSV</a>
         <a href="javascript:void" class="btn btn-secondary btn-sm export_to_xls_booking_desk"><i class="fa fa-download" aria-hidden="true"></i> Excel</a>
         <a href="javascript:void" class="btn btn-secondary btn-sm print_table_booking_desk"><i class="fa fa-print" aria-hidden="true"></i> Print</a>
         <?php 
         if($enable_show_all_fields){
         if (!isset($_GET["show_all_fields"])) { ?>
                    <a href="booking_desk.php?show_all_fields=yes" class="btn btn-secondary btn-sm"><i class="fa fa-print" aria-hidden="true"></i> Show All Fields</a>
                  <?php } }?>
        </div>
<!-- Col 1 ends -->
</div>
...
<!-- Add booking_desk Start-->
<div class="modal fade" id="add_booking_desk" tabindex="-1" role="dialog" aria-labelledby="add_booking_desk_LongTitle" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Add <?php echo beautify_meta_name(title_case("booking_desk"));?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
      </div>
      <div class="modal-body">
      <!-- booking_id>h,desk_id>h,start_time>i,end_time>i,duration>i,party_size>i --&gt<!-- Form Row Starts -->
        <form method="post" action="" id="form_booking_desk_rad648b162f7ce0b" class="w-100">
        <div class="row">
    <input type="hidden" class="form-control booking_desk_booking_id" name="booking_desk_booking_id">
    <input type="hidden" class="form-control booking_desk_desk_id" name="booking_desk_desk_id">
 <div class="form-group ic_booking_desk_start_time col-md-6 d-inline-block">
        ...
        <input type="text" class="form-control booking_desk_start_time" placeholder="Start Time"  name="booking_desk_start_time">
            </div>
 <div class="form-group ic_booking_desk_end_time col-md-6 d-inline-block">
        ...
        <input type="text" class="form-control booking_desk_end_time" placeholder="End Time"  name="booking_desk_end_time">
            </div>
 <div class="form-group ic_booking_desk_duration col-md-6 d-inline-block">
        ...
        <input type="text" class="form-control booking_desk_duration" placeholder="Duration"  name="booking_desk_duration">
            </div>
 <div class="form-group ic_booking_desk_party_size col-md-6 d-inline-block">
        ...
        <input type="text" class="form-control booking_desk_party_size" placeholder="Party Size"  name="booking_desk_party_size">
            </div>
        
        <div class="form-group col-md-12">
        <input type="submit" class="btn btn-success btn-sm insert_booking_desk" value="Add Booking Desk" form_id="rad648b162f7ce0b"> 
        </div>
        </form>
        </div>
        <!-- Form Row Ends -->
...
<!-- Add booking_desk Ends-->

<!-- Quick Edit Modal for booking_desk Start-->
<div class="modal fade" id="quick_edit_modal_booking_desk" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Update <?php echo beautify_meta_name(title_case("booking_desk")); ?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">×</span>
        </button>
      </div>
      <div class="modal-body ic_age_modal">
      <form method="post" action="" id="form_update_booking_desk_quick_edit" class="w-100">
      <input type="hidden" name="record_id" value="" class="quick_edit_booking_desk_record_id">
      <div class="modal_input_loader_booking_desk">

      </div>
      <div class="form-group col-md-12">
       
        <input type="submit" class="btn btn-success btn-sm update_booking_desk" value="Update <?php echo beautify_meta_name(title_case("booking_desk")); ?>" form_id="quick_edit"> 
        </div>
        </form>
      </div>
      <div class="modal-footer">
...
<!-- Quick Edit Modal booking_desk Ends-->
    ...
    //Search Filters Conditional changes
        ...
        //Insert variables
        var insert_button_class_booking_desk = ".insert_booking_desk"; // .classname
                var form_id_booking_desk = "#form_booking_desk";  // #entry_form
                var insert_api_url_booking_desk = "api/booking_desk/insert_booking_desk.php"; // /api/insert.php
                var form_id_parameter_name = "form_id";
                
                //Insert Operation
                $(document).on("click",insert_button_class_booking_desk,function(e){                
                e.preventDefault();
                //Processing
                swal("Processing","Please Wait","warning");
                //Processing
                var form_to_process_booking_desk = form_id_booking_desk + "_" + $(this).attr(form_id_parameter_name);
        
                $.post(insert_api_url_booking_desk,$(form_to_process_booking_desk).serializeArray(),function(data){
              ...
              icon: "error"
                    ...
                    $(form_to_process_booking_desk + " input[type=text]").first().focus();
...
var records_table_id = "#list_table_booking_desk";
$(".export_to_csv_booking_desk").click(function(){
$(records_table_id).tableToCSV();
});

$(".export_to_xls_booking_desk").click(function(){
...
$(".print_table_booking_desk").click(function(){
...
var delete_record_button_class_booking_desk = ".delete_booking_desk"; // .classname
var primary_record_key_attribute_name_booking_desk = "record_id"; //Name of attribute of particular record to edit/update/view/delete.
var delete_api_url_booking_desk = "api/booking_desk/delete_booking_desk.php"; // /api/delete.php

$(document).on("click",delete_record_button_class_booking_desk,function(e){
e.preventDefault();
...
.then((willDelete) => {
if (willDelete) {
  var record_id_booking_desk = $(this).attr(primary_record_key_attribute_name_booking_desk);
    
  $.post(delete_api_url_booking_desk,{"record_id":record_id_booking_desk});
...
.then((willDelete) => {
  ...
  var api_url = "api/booking_desk/delete_booking_desk.php"; //Replace with correct API url
...
$(document).ready( function () {
    ...
    if (isMobile) {
        $('#list_table_booking_desk').DataTable({
    paging: false,
    info: false,
    responsive: {
        details: true
...
//Quick Edit Code for booking_desk starts
$(".quick_edit_booking_desk").click(function(){
          var quick_edit_booking_desk_record_type = 'booking_desk';
          var quick_edit_booking_desk_record_id = $(this).attr("record_id");
          $(".quick_edit_booking_desk_record_id").val(quick_edit_booking_desk_record_id);
          var quick_edit_booking_desk_input_name = $(this).attr("quick_edit_input_name");
          $("#quick_edit_modal_booking_desk").modal("show");
          $(".modal_input_loader_booking_desk").load("edit_"+quick_edit_booking_desk_record_type+".php?"+quick_edit_booking_desk_record_type+"_id="+quick_edit_booking_desk_record_id+" .ic_"+quick_edit_booking_desk_input_name);
        });
        

//Update Variables for booking_desk
var qe_update_button_class_booking_desk= ".update_booking_desk"; // .classname
var qe_form_id_booking_desk = "#form_update_booking_desk";
var qe_update_api_url_booking_desk = "api/booking_desk/update_booking_desk.php"; // /api/update.php
 var qe_form_id_parameter_name_booking_desk = "form_id";
    //Update Operation
    	   $(document).on("click",qe_update_button_class_booking_desk,function(e){
e.preventDefault();
    		  var qe_form_to_process_booking_desk = qe_form_id_booking_desk + "_" + $(this).attr(qe_form_id_parameter_name_booking_desk);

    	 $.post(qe_update_api_url_booking_desk,$(qe_form_to_process_booking_desk).serializeArray(),function(data){
        var qe_response_json_booking_desk = data;

if(qe_response_json_booking_desk["status"] == "failure"){
  var qe_get_errors_booking_desk = qe_response_json_booking_desk["errors"];
 
    var errors_returned_booking_desk = "";
  $(qe_get_errors_booking_desk).each(function(index,value){
            errors_returned_booking_desk = errors_returned_booking_desk + " => " + value;
    });
    ...
    swal("Error",errors_returned_booking_desk, {
      icon: "error"
        ...
        //Reset Form
    		//$(qe_form_to_process_booking_desk)[0].reset();

        

    		 // Other functions to execute on success
    		   //Customized buttons
var qe_customized_content_booking_desk = document.createElement("div");
qe_customized_content_booking_desk.innerHTML = "<a href='javascript:void(0)' onClick='location.reload()' class='btn btn-sm btn-warning mt-1'>Refresh Changes</a> <br><br><a href='javascript:void(0)' onclick='swal.close()' class='btn btn-sm btn-danger'>Close Box</a>";
swal({
    title: "Updated",
    text: "Choose next action",
  content: qe_customized_content_booking_desk,
  buttons: false,
  icon : 'success',
});
//Customized buttons
...
//Quick Edit Code for booking_desk ends 
        </script>
