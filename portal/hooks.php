...
//     $where_array_desk_fetch = array("desk_size" => $desk_id);
...
//     $desk_record_id = get_single_value($results_desk_fetch, 'record_id');
...
//     $where_array_booking_fetch = array("booking_desk_id" => $desk_record_id);
...
function after_update_booking($insert_array,$response,$record_type){
  
//update query of booking_desk  #start
$record_update_controller = new records_update_controller();
$record_type_booking_desk_ = "booking_desk";
$update_array_booking_desk_ = array(
    "booking_desk_status"=>"Confirmed",
   "date_updated"=>generate_mysql_timestamp()
                            );
$where_array_booking_desk_ = array("booking_desk_booking_id"=>$response["record_id"]);
$update_record_booking_desk_ = $record_update_controller->update_record_with_new_values_and_where([$update_array_booking_desk_,$where_array_booking_desk_,$record_type_booking_desk_]);
//update query of booking_desk   #ends    

}
//Function Ends

//Function Starts
function after_delete_booking($post_array,$response,$record_type){
//delete query of booking_desk s #start
$record_delete_controller = new records_delete_controller();
$record_type_booking_desk_s = "booking_desk";
$where_array_booking_desk_s = array("booking_desk_booking_id"=>$response["record_id"]);
$record_delete_booking_desk_s = $record_delete_controller->delete_record_with_where([$where_array_booking_desk_s,$record_type_booking_desk_s]);
//delete query of booking_desk  s #ends    
