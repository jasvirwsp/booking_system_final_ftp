...
if (count($desk_meta) == 1) {
    ...
    $get_current_bookings = get_rec_meta_with_where("booking", ["booking_party_size" => safe_post("booking_party_size"), "date(date_created)" => get_today_date(),"booking_is_manual != ?" => "yes"], ["limit" => 1, "orderBy" => "record_id DESC"]);
    ...
    $record_type_array_booking_s = array(
        ...
        "booking_duration" => safe_post("booking_duration"),
