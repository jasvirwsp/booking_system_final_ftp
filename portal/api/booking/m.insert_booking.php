...
$post_parameter_array = array('booking_user_id','booking_visit_time','booking_visit_date','booking_party_size','booking_special_requirements','booking_remarks','booking_status','booking_duration','booking_desk_id');
...
//Hook
before_insert_booking($_POST,$record_type);
//Hook
...
// $booking_visit_time = $insert_record_array["booking_visit_time"];
// $booking_date = $insert_record_array["date_created"];
// $table_id = $insert_record_array["booking_desk_id"];

// $number_of_persons = get_value_with_id("desk>size", $table_id, "");

// $date = beautify_date($booking_date, 'beauty');

$record_id = $insert_id;


	$response = array("status"=>"success","message"=>"Insertion Success","record_id"=>$insert_id,"visit_time"=>$booking_visit_time,"date"=>$date);
	//Hook
	//after_insert_booking($_POST,$response,$record_type);
	//Hook
