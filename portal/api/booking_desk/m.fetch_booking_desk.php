...
$where_array = array("booking_desk_name != ?"=>""); // You can change it as per required
...
if(isset($_GET["search"])){
  ...
  $search_operators = array();  //Example $search_operators = array("booking_desk_name"=>"LIKE","date_created"=>"BETWEEN");
  $nested_where = array();
...
$response_array["booking_desk"] = $nest1;
